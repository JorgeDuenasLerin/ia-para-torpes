...
vgg16 = Sequential()
firsts_layers = vgg16_ori.layers[:17]
...
save('train_activations_sliced_1_aug.npy', train_activations)
save('train_labels_sliced_1_aug.npy', train_labels)
save('validation_activations_sliced_1_aug.npy', validation_activations)
save('validation_labels_sliced_1_aug.npy', validation_labels)
